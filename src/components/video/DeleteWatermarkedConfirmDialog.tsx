        ...
        <div className="p-6">
          <div className="flex items-start space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                This action cannot be undone. The watermarked video file will be permanently deleted from storage. The original video will remain unchanged.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-3">
            ...
            <Button 
              ...
              disabled={isDeleting}
            >
              {isDeleting ? 'Deleting...' : 'Delete Watermarked Video'}
            </Button>
          </div>
        </div>
      </div>
